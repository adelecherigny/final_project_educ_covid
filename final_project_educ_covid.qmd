...
#### Maths
```{r}
graph_mean_math_2018<-df_final%>%
  ggplot(aes(x= Mean_MATH_2018)) + 
  geom_density() 
```

```{r}
graph_mean_math_2022<-df_final%>%
  ggplot(aes(x= Mean_MATH_2022)) + 
  geom_density()
```

```{r}
graph_mean_math_2018 + graph_mean_math_2022 
```
#### Sciences
```{r}
graph_mean_scie_2018<-df_final%>%
  ggplot(aes(x= Mean_SCIE_2018)) + 
  geom_density() 
```

```{r}
graph_mean_scie_2022<-df_final%>%
  ggplot(aes(x= Mean_SCIE_2022)) + 
  geom_density()
```

```{r}
graph_mean_scie_2018 + graph_mean_scie_2022 
```

#### Lecture
```{r}
graph_mean_read_2018<-df_final%>%
  ggplot(aes(x= Mean_READ_2018)) + 
  geom_density() 
```

```{r}
graph_mean_read_2022<-df_final%>%
  ggplot(aes(x= Mean_READ_2022)) + 
  geom_density()
```

```{r}
graph_mean_read_2018 + graph_mean_read_2022 
```
...
#### Maths
```{r}
graph_sd_math_2018<-df_final%>%
  ggplot(aes(x= SD_MATH_2018)) + 
  geom_density() 
```

```{r}
graph_sd_math_2022<-df_final%>%
  ggplot(aes(x= SD_MATH_2022)) + 
  geom_density()
```

```{r}
graph_sd_math_2018 + graph_sd_math_2022 
```
#### Sciences
```{r}
graph_sd_scie_2018<-df_final%>%
  ggplot(aes(x= SD_SCIE_2018)) + 
  geom_density() 
```

```{r}
graph_sd_scie_2022<-df_final%>%
  ggplot(aes(x= SD_SCIE_2022)) + 
  geom_density()
```

```{r}
graph_sd_scie_2018 + graph_sd_scie_2022 
```

#### Lecture

```{r}
graph_sd_read_2018<-df_final%>%
  ggplot(aes(x= SD_READ_2018)) + 
  geom_density() 
```

```{r}
graph_sd_read_2022<-df_final%>%
  ggplot(aes(x= SD_READ_2022)) + 
  geom_density()
```

```{r}
graph_sd_read_2018 + graph_sd_read_2022 
```
