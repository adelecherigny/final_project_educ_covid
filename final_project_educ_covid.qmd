...
df_final %>%
  ...
  geom_density(aes(color = "2018")) +  # Courbe de densité 2018 avec couleur
  geom_rug(aes(color = "2018"), alpha = 0.5) +  # Rugosités pour 2018 avec couleur
  geom_density(aes(x = Mean_MATH_2022, color = "2022")) +  # Courbe de densité 2022 avec couleur
  geom_rug(aes(x = Mean_MATH_2022, color = "2022"), alpha = 0.5) +  # Rugosités pour 2022 avec couleur
  scale_color_manual(values = c("2018" = "blue", "2022" = "red")) +  # Définit les couleurs
  labs(color = "Year") +  # Ajoute une légende pour les couleurs
...
df_final %>%
  ...
  geom_density(aes(color = "2018")) +  # Courbe de densité 2018 avec couleur
  geom_rug(aes(color = "2018"), alpha = 0.5) +  # Rugosités pour 2018 avec couleur
  geom_density(aes(x = Mean_SCIE_2022, color = "2022")) +  # Courbe de densité 2022 avec couleur
  geom_rug(aes(x = Mean_SCIE_2022, color = "2022"), alpha = 0.5) +  # Rugosités pour 2022 avec couleur
  scale_color_manual(values = c("2018" = "blue", "2022" = "red")) +  # Définit les couleurs
  labs(color = "Year") +  # Ajoute une légende pour les couleurs
  theme_minimal()  # Applique un thème minimal
...
df_final %>%
  ...
  geom_density(aes(color = "2018")) +  # Courbe de densité 2018 avec couleur
  geom_rug(aes(color = "2018"), alpha = 0.5) +  # Rugosités pour 2018 avec couleur
  geom_density(aes(x = Mean_READ_2022, color = "2022")) +  # Courbe de densité 2022 avec couleur
  geom_rug(aes(x = Mean_READ_2022, color = "2022"), alpha = 0.5) +  # Rugosités pour 2022 avec couleur
  scale_color_manual(values = c("2018" = "blue", "2022" = "red")) +  # Définit les couleurs
  labs(color = "Year") +  # Ajoute une légende pour les couleurs
  theme_minimal()  # Applique un thème minimal
...
df_final %>%
  ...
  geom_density(aes(color = "2018")) +  # Courbe de densité 2018 avec couleur
  geom_rug(aes(color = "2018"), alpha = 0.5) +  # Rugosités pour 2018 avec couleur
  geom_density(aes(x = SD_MATH_2022, color = "2022")) +  # Courbe de densité 2022 avec couleur
  geom_rug(aes(x = SD_MATH_2022, color = "2022"), alpha = 0.5) +  # Rugosités pour 2022 avec couleur
  scale_color_manual(values = c("2018" = "blue", "2022" = "red")) +  # Définit les couleurs
  labs(color = "Year") +  # Ajoute une légende pour les couleurs
  theme_minimal()  # Applique un thème minimal
...
df_final %>%
  ...
  geom_density(aes(color = "2018")) +  # Courbe de densité 2018 avec couleur
  geom_rug(aes(color = "2018"), alpha = 0.5) +  # Rugosités pour 2018 avec couleur
  geom_density(aes(x = SD_SCIE_2022, color = "2022")) +  # Courbe de densité 2022 avec couleur
  geom_rug(aes(x = SD_SCIE_2022, color = "2022"), alpha = 0.5) +  # Rugosités pour 2022 avec couleur
  scale_color_manual(values = c("2018" = "blue", "2022" = "red")) +  # Définit les couleurs
  labs(color = "Year") +  # Ajoute une légende pour les couleurs
  theme_minimal()  # Applique un thème minimal
...
# Utilisation de mutate et case_when pour créer la variable binaire
df_final <- df_final %>%
