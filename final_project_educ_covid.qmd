...
```{r}
nombre_lignes <- PISA_2018 |> nrow()
nombre_colonnes <- PISA_2018 |> ncol()
cat("Le fichier PISA 2018 contient", nombre_lignes, "lignes et", nombre_colonnes, "colonnes")
```
...
```{r}
library(dplyr)
column_names <- names(select(PISA_2018, starts_with("PV")))
print(column_names)
```
