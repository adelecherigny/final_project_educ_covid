...
ggplot(df_final, aes(x = closure_large_count, y = evolution_MATH)) +
 ...
 labs(
    title = "Impact des Fermetures d'Écoles sur l'Évolution des Performances en Mathématiques",
    x = "Fermeture des Écoles (closure_large_count)",
    y = "Évolution des Moyennes en Mathématiques (2018-2022)",
